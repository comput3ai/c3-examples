    ...
    <div className="max-w-2xl mx-auto space-y-6">
      <div className="text-center space-y-2">
        ...
        <p className="text-gray-300">
          Enter your C3 API key to connect to the compute cluster
        </p>
      </div>
        ...
        <div className="flex items-start space-x-2">
          ...
          <div className="text-sm">
            ...
            <p className="text-gray-200 mb-2">
              {isProduction 
                ? 'API requests are routed through Netlify proxy for security.'
            ...
            <div className="bg-gray-700 rounded p-3 mt-2">
              {isProduction ? (
                <>
                  <p className="font-medium text-green-400 mb-1">✅ Netlify Proxy Active:</p>
                  <p className="text-green-300 text-xs">
                    External API calls routed through secure proxy
                  </p>
                </>
              ) : (
                <>
